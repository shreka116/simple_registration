...
local M = {}
local ABIDEDataset = torch.class('BRR.ABIDEDataset', M)

function ABIDEDataset:__init(imageInfo, opt, split)
...
function ABIDEDataset:_loadImage(path)
...
function ABIDEDataset:preprocess()
